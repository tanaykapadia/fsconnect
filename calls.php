...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
            <h1 class="display-4">Video Chat with your Friends!</h1>
            <p class="lead">Simply tell users to open FSConnect, create, and login with an account and join the URL in your browser.</p>
            <hr class="my-4">
            <p>It's as simple as that!</p>
            <a class="btn btn-dark btn-lg" onclick="copyURL()" role="button">Copy URL to clipboard</a>
        </div>
        <textarea id="myInput">localhost/fsconnect/calls.php</textarea>
        <script>
